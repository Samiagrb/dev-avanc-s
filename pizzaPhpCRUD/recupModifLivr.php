...
<body>
	...
	echo($dateEmbauche);
        ...
        if($bdd = mysqli_connect('localhost', 'root', '', 'pizza')){
        echo("<br>Je suis connecté");


        $sql1="UPDATE livreur SET NomLivr='$nom', PrenomLivr='$prenom', DatEmbauchLivr='$dateEmbauche' WHERE NroLivr=".$_POST['numLivr'];
