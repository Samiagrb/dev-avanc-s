...
<body>
 <a type="button" class="btn btn-info" href="createPizza.jsp">Creer pizza</a>
	<%
	     ...
	     %>
	        ...
	        while (rs.next()) {            // Va aller voir toutes les lignes de rs%> 
                ...
                <div class="description">
                    ...
                    <p><u>Prix :</u> <%= rs.getString(3) %> euros</p>
                   <a type="button" class="btn btn-success" href="modifPizza.jsp?NumPizz=<%=rs.getString(1) %>">Modifier</a>
                    <a type="button" class="btn btn-danger" href="suppPizza.jsp?NumPizz=<%=rs.getString(1) %>">Supprimer</a>
                </div>
            </div>
	        <% }
	        %>
